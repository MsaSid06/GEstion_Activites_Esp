...
require_once '../Gestionnaire/models/structure.php';
...
$structure = getToutesStructures($pdo);
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <<<<<<< HEAD <header
        ...
        <div class="flex items-center gap-3">
            ...
            <header class="bg-[#650665] px-6 py-5 flex justify-between items-center sticky top-0 z-40 shadow-md">
                <div class="flex items-center gap-3">
                    <div
                        class="w-12 h-12 rounded-full bg-white text-[#650665] flex items-center justify-center font-black text-lg">
                    ...
                    <div>
                        ...
                        <small
                            class="text-white/75 text-xs block"><?= ucfirst(strtolower($_SESSION['profil'])) ?></small>
                            ...
                            <div id="notifications-dropdown"
                                ...
                                <div class="flex justify-between items-center border-b pb-2">
                                    ...
                                    <a href="./notifications.php"
                                        class="text-xs text-esp-purple font-semibold hover:underline">Voir
                                        tout</a>
                                </div>
                                <div id="notif-list"
                                    class="space-y-2.5 max-h-60 overflow-y-auto text-xs custom-scrollbar pr-1">
                                    <?php if (count($notifications) > 0): ?>
                                    ...
                                    <div class="p-2 bg-purple-50 rounded-xl border border-purple-100/50">
                                        ...
                                        <span
                                            class="text-gray-400 text-[10px]"><?= htmlspecialchars($n['date_envoi']) ?></span>
                                    </div>
                                    <?php endforeach; ?>
                                    <?php else: ?>
            ...
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <section id="view-dashboard" class="space-y-8 block">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <<<<<<< HEAD <div onclick="filterDashboard('AVENIR', null)"
                ...
                <section id="view-activities-list" class="space-y-8 hidden">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p id="activities-count" class="text-sm text-gray-500 font-medium mt-1">0 activités
                                enregistrées</p>
                        </div>
                ...
                <section id="view-activity-details" class="max-w-4xl mx-auto hidden space-y-6">
                    ...
                    <div class="bg-white rounded-[24px] shadow-sm border border-gray-100 overflow-hidden">
                        <div class="bg-esp-purple p-8 md:p-10 text-white space-y-4">
                            ...
                            <h2 id="det-title" class="text-2xl md:text-3xl font-black tracking-tight">Titre de
                                l'activité</h2>
                        </div>
