...
<p id="user-full-name" class="text-xs text-gray-500 font-medium">
        ...
        <div class="flex items-center gap-6 relative">
            ...
            <div id="notifications-dropdown" class="absolute right-0 top-10 bg-white border border-gray-100 w-80 rounded-2xl shadow-xl p-4 hidden space-y-3 z-50">
                <div class="flex justify-between items-center border-b pb-2">
                    ...
                    <button onclick="clearNotifications()" class="text-xs text-esp-purple font-semibold hover:underline">Tout marquer lu</button>
                </div>
                <div id="notif-list" class="space-y-2.5 max-h-60 overflow-y-auto text-xs custom-scrollbar pr-1"></div>
            </div>

            <a href="/GestionDesActiviteEsp/Gestionnaire/controllers/logout.php" class="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-red-600 transition">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section id="view-dashboard" class="space-y-8 block">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div onclick="filterDashboard('AVENIR')" class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-between min-h-[140px] cursor-pointer hover:shadow-md transition">
                ...
                <div onclick="filterDashboard('EN_COURS')" class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-between min-h-[140px] cursor-pointer hover:shadow-md transition">
                ...
                <div onclick="filterDashboard('TERMINE')" class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-between min-h-[140px] cursor-pointer hover:shadow-md transition">
                ...
                <div class="lg:col-span-8 space-y-4">
                    <div class="bg-white p-3 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-3 items-center justify-between">
                        ...
                        <div class="flex gap-1 overflow-x-auto w-full sm:w-auto">
                            <button onclick="filterDashboard('ALL')" class="dash-filter-btn bg-esp-purple text-white px-5 py-2.5 rounded-full text-xs font-bold shadow-sm">Tout</button>
                            <button onclick="filterDashboard('AVENIR')" class="dash-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">À venir</button>
                            <button onclick="filterDashboard('EN_COURS')" class="dash-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">En cours</button>
                            <button onclick="filterDashboard('TERMINE')" class="dash-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">Terminé</button>
                        </div>
                    </div>
        ...
        <section id="view-activities-list" class="space-y-8 hidden">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div class="md:col-span-4 flex gap-1 justify-end">
                    <button onclick="filterGrid('ALL')" class="grid-filter-btn bg-esp-purple text-white px-5 py-2.5 rounded-full text-xs font-bold shadow-sm">Tout</button>
                    <button onclick="filterGrid('AVENIR')" class="grid-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">À venir</button>
                    <button onclick="filterGrid('EN_COURS')" class="grid-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">En cours</button>
                    <button onclick="filterGrid('TERMINE')" class="grid-filter-btn bg-white border border-gray-200 text-gray-600 px-5 py-2.5 rounded-full text-xs font-semibold hover:bg-gray-50">Terminé</button>
                </div>
            </div>
    ...
    <div class="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 px-4 w-auto max-w-md">
        <div class="bg-[#4A0E4E] text-white rounded-full shadow-xl px-4 py-2 flex items-center gap-4 border border-purple-950/40">
            ...
            <a href="/GestionDesActiviteEsp/profil.php" title="Gestion du profil" class="relative flex items-center justify-center cursor-pointer">
                <div id="dock-avatar" class="w-8 h-8 bg-[#322336] text-[#A697A8] text-xs font-bold rounded-full flex items-center justify-center border border-purple-800/40">
